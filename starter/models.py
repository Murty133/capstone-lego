...
collection = db.Table('collection',
    Column('collector_id', Integer, ForeignKey('collectors.id'), primary_key=True),
...
class Collector(db.Model):  
  ...
  legos = db.relationship('Set', secondary=collection, backref=db.backref('collectors', lazy=True))
